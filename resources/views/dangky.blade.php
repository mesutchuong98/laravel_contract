...
<head>
  ...
  <title>Admin Contract| Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('almasaeed2010/adminlte/plugins/iCheck/square/blue.css')}}">
...
<body class="hold-transition register-page">
  <div class="register-box">
    ...
    <div class="register-box-body">
      ...
      <a href="{{Route('dangnhap')}}" class="text-center">I already have a membership</a>
    </div>
    <!-- /.form-box -->
  </div>
...
<!-- iCheck -->
<script src="{{asset('almasaeed2010/adminlte/plugins/iCheck/icheck.min.js')}}"></script>
<script>
  $(function () {
    $('input').iCheck({
